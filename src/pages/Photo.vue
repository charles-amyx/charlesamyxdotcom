  ...
  <Layout>
    <section class="flex-1">
      ...
      <div v-if="$page.posts.edges" class="px-2">
        <div class="flex flex-wrap items-stretch -mx-4 posts">
          <div class="h-full px-4 mb-8 overflow-hidden w-100 md:w-1/3 max-h-360" v-for="edge in $page.posts.edges" :key="edge.node.id">
            <g-image
