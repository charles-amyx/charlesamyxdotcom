  ...
  <Layout>
    <div class="w-full leading-relaxed">
      <section class="flex-1 w-full max-w-6xl py-10 mx-auto md:px-16 lg:py-24">
        ...
        <hr class="mb-12" />
        <p>
          A little more detail on the design process I've been involved with
          recently. Poverty Solutions was one of my last design projects at
      ...
      <figure class="w-full mt-10">
        <g-image
          ...
          alt="an image of a site map for poverty solutions"
        />
        <figcaption
      ...
      <section
        class="flex-1 w-full max-w-6xl px-6 py-10 mx-auto md:px-16 content lg:py-24"
      >
        <h2 class="text-2xl font-normal leading-none md:text-3xl lg:text-4xl">
      ...
      <figure class="w-full mt-10">
        <g-image
          ...
          alt="an image of a polished wireframe created in an application"
        />
        <figcaption
          class="max-w-6xl px-6 mx-auto mt-1 text-sm leading-none text-right text-gray-800 "
        >
      ...
      <figure class="w-full mt-10">
        <g-image
          class="w-full pb-8"
          src="~/assets/versions.jpg"
          alt="an image of two versions of a design for a web page"
        />
        <figcaption
          class="max-w-6xl px-6 mx-auto mt-1 text-sm leading-none text-right text-gray-800 "
        >
      ...
      <figure class="w-full mt-10">
        <g-image
          ...
          alt="an image of the final version of a design for a web page"
        />
        <figcaption
          class="max-w-6xl px-6 mx-auto mt-1 text-sm leading-none text-right text-gray-800 "
        >
